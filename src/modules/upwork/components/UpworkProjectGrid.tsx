...
} from '@/modules/projects/screenshots'
  ...
  return (
    ...
    >
      <Link
        ...
        onTouchStart={warm}
      >
        <ScreenshotThumbnail project={project} showCount={false} />
      ...
      <div className="container-main">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <UpworkProjectCard key={project.id} project={project} index={index} />
          ))}
        </div>
      </div>
    </section>
